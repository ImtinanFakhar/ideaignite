...
const DemoProduct = (props) => {
    ...
    function sendEmail(e) {
        ...
        fData.append('products', demoProducts)
         ...
         email.sendForm('service_c2o2xjb', 'template_nr2p8a4', e.target, '2SfExqYFm1w17PWkQ')
           .then((result) => {
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            <div className="flex">
                                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Place an</h1>
                            </div>
